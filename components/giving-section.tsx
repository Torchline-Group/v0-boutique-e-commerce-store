...
export function GivingSection() {
  return (
    <section id="giving" className="py-20 lg:py-28 bg-primary">
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <div className="mt-6 space-y-4 text-primary-foreground/85 leading-relaxed">
              <p>
            ...
            <Button
              size="lg"
              className="mt-8 bg-cream text-warm-brown hover:bg-sand px-8 py-6 text-sm tracking-widest uppercase font-medium"
            >
              Suggest a Cause
